...
import { headingConfigs, type Options, type Style } from "./types";
            ...
            try {
                ...
                if (trimmedLine.startsWith("```")) {
                    if (!inCodeBlock) {
                        ...
                        inCodeBlock = true;
                        codeBlockLanguage =
                            trimmedLine.slice(3).trim() || undefined;
                        codeBlockContent = "";
                    } else {
                        // End of code block
                        inCodeBlock = false;
                    ...
                    if (match) {
                        ...
                        if (level >= 1 && level <= 5) {
                            ...
                            const config = {
                                ...
                                alignment:
                                    headingConfigs[level].alignment ||
                    ...
                    if (
                        ...
                        if (tableIndex < tables.length) {
                            try {
                                ...
                                const tableRowCount =
                                    2 + tables[tableIndex].rows.length;
                                i += tableRowCount - 1;
                                tableIndex++;
                                continue;
                            } catch {
                ...
                if (
                    ...
                    listItems.push(
                        processListItem({ text: listText, boldText }, style),
                    );
                    continue;
                }
        ...
        if (headings.length > 0) {
            ...
            headings.forEach((heading) => {
                ...
                switch (heading.level) {
                    case 1:
                        fontSize =
                            style.tocHeading1FontSize || style.tocFontSize;
                        isBold =
                    ...
                    case 2:
                        fontSize =
                            style.tocHeading2FontSize || style.tocFontSize;
                        isBold =
...
export function downloadDocx(
    ...
    if (typeof window === "undefined") {
        throw new Error(
            "This function can only be used in browser environments",
        );
    }
